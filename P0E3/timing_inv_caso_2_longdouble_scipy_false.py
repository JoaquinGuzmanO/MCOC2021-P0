...
#Tamaño
for i in range(1,11):
	text = open("rendimiento_scipy_false_longdouble_"+str(i)+".txt","w")

	ns= [5,10,20,50,100,200,500,1000,2000,5000]

	for N in ns:

		A = laplaciana(N, dtype = longdouble) ### hay que variar los float

		t1 = perf_counter()
		Am1 = inv(A, overwrite_a=False) #variar la funcion con la que invertir
		t2 = perf_counter()
		dt = t2-t1
