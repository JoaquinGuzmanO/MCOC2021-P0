...
from numpy import double, zeros, eye, ones
...
tiempos=[]
promedios=[]
text = open("rendimiento_EDfC3.txt","w") #Cambiar nombre

for i in range(1,11):
	ns= [2,5,10,20,50,100,200,500,1000,1500]
	t = []
	for N in ns:

		A = laplaciana(N, double) ### hay que variar el tipo de dato
		t1 = perf_counter()
		e = eigh(A,driver="evd",overwrite_a = False) ### cambiarrrr
		t2 = perf_counter()
		dt = t2-t1
		t.append(dt)	
	tiempos.append(t)
